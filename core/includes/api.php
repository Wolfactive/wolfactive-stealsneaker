...
/*Api city and provinde for cart page*/
add_action('rest_api_init','placeRegisterApiSearch');
function placeRegisterApiSearch(){
  register_rest_route('place-api/v1','search',array(
    'methods'   =>  WP_REST_SERVER::READABLE,
    'callback'  =>  'placeApiSearchResult'
  ));
}
function placeApiSearchResult(){
  $placeResult = array (
  1 =>
  array (
