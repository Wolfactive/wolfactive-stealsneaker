...
function doRenderCart(){
  if(productBuyArray.length !== 0){
    ...
    productTemplate += "<tr style=\" margin: 20px 0px\">\n    <td><img style=\" width:100px\" src=\"" + item.hinhSanPham + "\" alt=\"hinh-anh-san-pham\" /></td>\n    <td>" + item.tenSanPham + "(" + item.sizeSanPham + ")</td>\n    <td>SL:" + item.soLuongSanPham + "</td>\n    <td>Giá:" + giaGioSP + "</td>\n   </tr><hr/>";
