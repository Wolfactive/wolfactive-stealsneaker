...
<head>
     ...
     <link rel="stylesheet" href="<?php echo get_theme_file_uri('assets/css/globals.min.css.gz') ?>">
     <script defer type='text/javascript' src="<?php echo get_theme_file_uri('assets/js/main.min.js.gz') ?>"></script>
     <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php if(wp_is_mobile()): ?>
